...
if ( ! function_exists( 'ot_register_theme_options_admin_bar_menu' ) ) {
  ...
  function ot_register_theme_options_admin_bar_menu( $wp_admin_bar ) {
    ...
    $wp_admin_bar->add_node( array(
      ...
      'title'   => apply_filters( 'ot_theme_options_page_title', __( 'Theme Options', 'zoom-lite' ) ),
 ...
 * @since     2.3.0
 */
if ( ! function_exists( 'zoom_replace_media_upload_button' ) ) {

  function zoom_replace_media_upload_button() {
    
    return __( 'Insert', 'zoom-lite' );
