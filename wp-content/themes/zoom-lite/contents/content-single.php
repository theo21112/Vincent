...
<?php do_action( 'zoom_struct_data_author' ); ?>
	...
	<div class="entry-content clearfixafter">
    	<?php if ( get_post_format() ) { get_template_part( 'templates/post-formats' ); } ?>
		<?php the_content(); ?>
		<?php zoom_custom_wp_link_pages(); ?>
	</div><!-- .entry-content -->

	<footer class="entry-meta">
		<?php zoom_single_post_meta(); ?>
...
<?php if ( get_theme_mod( 'post_related' ) != 'disable' ) { get_template_part( 'templates/related', 'posts' ); } ?>